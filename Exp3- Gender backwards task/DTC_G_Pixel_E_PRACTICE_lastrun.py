...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.83.04), Wed 20 Mar 15:58:00 2019
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'/Users/tobynicholson/Dropbox/new dtc - male:female/G/E/DTC_G_Pixel_E_PRACTICE.psyexp',
...
polygon_8 = visual.Rect(win=win, name='polygon_8',
    ...
    opacity=1,depth=-2.0, 
interpolate=True)
polygon_12 = visual.Rect(win=win, name='polygon_12',
    width=[0.25, 0.25][0], height=[0.25, 0.25][1],
    ori=0, pos=[0.2, -0.2],
    lineWidth=1, lineColor=[1,1,1], lineColorSpace='rgb',
    fillColor=[1,1,1], fillColorSpace='rgb',
...
trials = data.TrialHandler(nReps=1, method='sequential', 
    ...
    trialList=data.importConditions('Pixel_practice.xlsx'),
...
instructions2Components.append(text_5)
...
for thisTrial_3 in trials_3:
    ...
    sound_aloneComponents.append(text_10)
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        # *text_10* updates
        if t >= 6 and text_10.status == NOT_STARTED:
            # keep track of start time/frame for later
            text_10.tStart = t  # underestimates by a little under one frame
            text_10.frameNStart = frameN  # exact frame index
            text_10.setAutoDraw(True)
        if text_10.status == STARTED and t >= (6 + (2-win.monitorFramePeriod*0.75)): #most of one frame period left
...
instructions3Components.append(text_11)
...
for thisTrial_5 in trials_5:
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        # *text_12* updates
        if t >= 1 and text_12.status == NOT_STARTED:
            # keep track of start time/frame for later
            text_12.tStart = t  # underestimates by a little under one frame
            text_12.frameNStart = frameN  # exact frame index
            text_12.setAutoDraw(True)
        if text_12.status == STARTED and t >= (1 + (3-win.monitorFramePeriod*0.75)): #most of one frame period left
        ...
        # *text_13* updates
        if t >= 1 and text_13.status == NOT_STARTED:
            # keep track of start time/frame for later
            text_13.tStart = t  # underestimates by a little under one frame
            text_13.frameNStart = frameN  # exact frame index
            text_13.setAutoDraw(True)
        if text_13.status == STARTED and t >= (1 + (3-win.monitorFramePeriod*0.75)): #most of one frame period left
            text_13.setAutoDraw(False)
        if text_13.status == STARTED:  # only update if being drawn
            text_13.setText(t3, log=False)
    ...
    for thisTrial_4 in trials_4:
        ...
        while continueRoutine and routineTimer.getTime() > 0:
            ...
            if text_14.status == STARTED and t >= (0.0 + (3-win.monitorFramePeriod*0.75)): #most of one frame period left
            ...
            if text_15.status == STARTED and t >= (0.0 + (3-win.monitorFramePeriod*0.75)): #most of one frame period left
    ...
    text_17.setColor(feedback_colour, colorSpace='rgb')
    text_17.setText(score_feedback)
    # keep track of which components have finished
    feedback2Components = []
    feedback2Components.append(image_2)
    feedback2Components.append(text_17)
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        if text_17.status == STARTED and t >= (0.0 + (1.0-win.monitorFramePeriod*0.75)): #most of one frame period left
...
# get names of stimulus parameters
if trials_5.trialList in ([], [None], None):  params = []
else:  params = trials_5.trialList[0].keys()
# save data for this loop
...
# keep track of which components have finished
bridgeComponents = []
bridgeComponents.append(text_18)
...
while continueRoutine and routineTimer.getTime() > 0:
    ...
    if text_18.status == STARTED and t >= (0.0 + (2-win.monitorFramePeriod*0.75)): #most of one frame period left
...
while continueRoutine and routineTimer.getTime() > 0:
    ...
    if text_19.status == STARTED and t >= (0.0 + (2-win.monitorFramePeriod*0.75)): #most of one frame period left

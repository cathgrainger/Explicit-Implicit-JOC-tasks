...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.83.04), Sun 26 Aug 18:20:49 2018
...
expName = 'Colour E points'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'/Users/tobynicholson/Dropbox/ASD.KIDS/G Tasks/E/G_Colour_E_points.psyexp',
...
trials = data.TrialHandler(nReps=1, method='sequential', 
    ...
    trialList=data.importConditions(u'BlueParameters_Dichotomous.xlsx'),
...
for thisTrial in trials:
    ...
    for thisTrial_2 in trials_2:
        ...
        thisExp.addData('RT3',RT3)
        thisExp.addData('check',check)

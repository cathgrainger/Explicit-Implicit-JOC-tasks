...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.83.04), June 14, 2018, at 12:40
...
expName = u'Pixel I points'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'C:\\Users\\tmn\\Desktop\\ASD.KIDS\\G Tasks\\I\\G_Pixel_I_points.psyexp',
...
text_4 = visual.TextStim(win=win, ori=0, name='text_4',
    text=u'End of practice',    font=u'Arial',
    pos=[0, 0], height=0.1, wrapWidth=None,
...
trials = data.TrialHandler(nReps=1, method='sequential', 
    ...
    trialList=data.importConditions('PixelParameters_Dichotomous.xlsx'),
